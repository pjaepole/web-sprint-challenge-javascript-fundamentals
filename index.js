...
//🚀🚀🚀 ⬇️ 📝 Explanation ⬇️ 📝 🚀🚀🚀: 
// nestedFunction can access the variable internal due to the closure. closure happens when a inner function in this case nested 
// function can reach out to outer function to grab a value that is defined in the outerfunction.
...
function summation(number){
  let sum=0;
  for(let i=0; i<=number; i++){sum= sum+ i}
  return sum;
}
